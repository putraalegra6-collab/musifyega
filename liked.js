    ...
    render() {
        ...
        if(liked.length > 0) {
            likedHtml = liked.map(function(s, i) {
                ...
                return '<div data-lp-source="liked" data-lp-index="'+i+'" class="rounded-2xl '+cardBg+' p-2.5 flex items-center gap-3 active:scale-[0.98] transition-all duration-300 group shadow-lg shadow-black/25">'+
        ...
        el.innerHTML = '<div class="pt-8 pb-3.5 px-4 sticky top-0 z-30 border-b border-white/10 shadow-2xl transition-all flex justify-between items-center" style="background: linear-gradient(180deg, rgba(232, 120, 159, 0.12) 0%, rgba(13, 13, 12, 0.45) 55%, rgba(13, 13, 12, 0.92) 100%); backdrop-filter: blur(12px); -webkit-backdrop-filter: blur(12px);">'+
